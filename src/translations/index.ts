...
export const translations = {
  ...
  tamil: {
    ...
    vitalsGreat:
      "உங்கள் உடல்நல தரவுகளின் அடிப்படையில், இன்று உங்கள் உயிர் அறிகுறிகள் மிகவும் சிறப்பாக உள்ளன.",
    medicationReminder:
      "மதியம் 2 மணிக்கு உங்கள் இரத்த அழுத்த மருந்தை எடுக்க மறக்காதீர்கள்.",
    nextCheckup:
      "டாக்டர். சர்மாவுடன் உங்கள் அடுத்த பரிசோதனை 3 மணி நேரத்தில் உள்ளது.",
    ...
    bloodPressureRecorded:
      "இரத்த அழுத்தம் பதிவு செய்யப்பட்டது: 120/80 (சாதாரண)",
  ...
  telugu: {
    ...
    vitalsGreat:
      "మీ ఆరోగ్య డేటా ఆధారంగా, ఈరోజు మీ జీవన సంకేతాలు చాలా బాగున్నాయి.",
    medicationReminder:
      "మధ్యాహ్నం 2 గంటలకు మీ రక్తపోటు మందు తీసుకోవడం మర్చిపోవద్దు.",
  ...
  bengali: {
    ...
    vitalsGreat:
      "আপনার স্বাস্থ্য তথ্যের ভিত্তিতে, আজ আপনার জীবনীশক্তি দুর্দান্ত দেখাচ্ছে।",
  ...
  marathi: {
    ...
    goodMorning: "सुप्रभात, राजेश!",
    vitalsGreat:
      "तुमच्या आरोग्य डेटाच्या आधारे, आज तुमचे जीवनसंकेत उत्कृष्ट दिसत आहेत.",
  ...
  punjabi: {
    ...
    vitalsGreat:
      "ਤੁਹਾਡੇ ਸਿਹਤ ਡੇਟਾ ਦੇ ਆਧਾਰ ਤੇ, ਅੱਜ ਤੁਹਾਡੇ ਜੀਵਨ ਸੰਕੇਤ ਬਹੁਤ ਵਧੀਆ ਲੱਗ ਰਹੇ ਹਨ।",
